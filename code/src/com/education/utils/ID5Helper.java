...
public class ID5Helper {
     ...
     */
    public static String validate(String id5) throws ParseException {
        String errorInfo = "";// 记录错误信息
        String[] valCodeArr = { "1", "0", "x", "9", "8", "7", "6", "5", "4", "3", "2" };
        String[] wi = { "7", "9", "10", "5", "8", "4", "2", "1", "6", "3", "7", "9", "10", "5", "8", "4", "2" };
        String ai = "";
        // ================ 号码的长度 15位或18位 ================
        if (id5.length() != 15 && id5.length() != 18) {
        ...
        // ================ 数字 除最后以为都为数字 ================
        if (id5.length() == 18) {
            ai = id5.substring(0, 17);
        } else if (id5.length() == 15) {
            ai = id5.substring(0, 6) + "19" + id5.substring(6, 15);
        }
        if (!isNumeric(ai)) {
